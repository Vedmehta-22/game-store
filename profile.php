  ...
  <main>
    <div class="profile-container">
      ...
      <div class="profile-header-card">
        ...
        <div class="profile-header-info-wrap">
          <div>
      ...
      <section class="recently-played">
        ...
        <?php if ($games_owned_count == 0): ?>
          <p style="color: var(--text-muted); text-align: center;">No games played recently. Start playing some games from your library!</p>
        <?php else: ?>
