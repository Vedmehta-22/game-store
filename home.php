...
<body>
  ...
  <header>
    <div class="nav-container">
      <h1>GameStore</h1>
      <nav>
        <a href="home.php" class="active">Store</a>
  ...
  <section class="hero-section">
    <div class="hero-content">
      ...
      <p class="hero-subtitle">Step into Night City, a massive neon-lit futuristic metropolis where choices shape your destiny. Mod your body, hack, and make your mark.</p>
      ...
      <div class="game-card" onclick="openGame('game.php?game=<?php echo $id; ?>')">
        ...
        <div class="game-card-info">
          ...
          <div class="game-card-meta">
            ...
            <span class="game-card-price <?php echo $game['price'] == 0 ? 'free' : ''; ?>">
